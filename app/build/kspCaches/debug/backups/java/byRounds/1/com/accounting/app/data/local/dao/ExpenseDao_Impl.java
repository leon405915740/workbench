...
public final class ExpenseDao_Impl implements ExpenseDao {
  ...
  public ExpenseDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfExpenseEntity = new EntityInsertionAdapter<ExpenseEntity>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `expense` (`id`,`amount`,`category`,`subcategory`,`merchant`,`time`,`note`,`confidence`,`rawInput`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?)";
      }

      @Override
      public void bind(SupportSQLiteStatement stmt, ExpenseEntity value) {
    ...
    this.__preparedStmtOfDeleteById = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "DELETE FROM expense WHERE id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateCategory = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE expense SET category = ?, subcategory = ? WHERE id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object insert(final ExpenseEntity expense, final Continuation<? super Long> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Long>() {
      @Override
      public Long call() throws Exception {
        __db.beginTransaction();
        try {
          long _result = __insertionAdapterOfExpenseEntity.insertAndReturnId(expense);
  ...
  @Override
  public Object delete(final ExpenseEntity expense, final Continuation<? super Unit> continuation) {
  ...
  @Override
  public Object getById(final long id, final Continuation<? super ExpenseEntity> continuation) {
      ...
      public ExpenseEntity call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            _result = new ExpenseEntity(_tmpId,_tmpAmount,_tmpCategory,_tmpSubcategory,_tmpMerchant,_tmpTime,_tmpNote,_tmpConfidence,_tmpRawInput,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<List<ExpenseEntity>> getByTimeRange(final long startTime, final long endTime) {
    final String _sql = "SELECT * FROM expense WHERE time BETWEEN ? AND ? ORDER BY time DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, startTime);
    _argIndex = 2;
    _statement.bindLong(_argIndex, endTime);
    return CoroutinesRoom.createFlow(__db, false, new String[]{"expense"}, new Callable<List<ExpenseEntity>>() {
      @Override
      public List<ExpenseEntity> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _item = new ExpenseEntity(_tmpId,_tmpAmount,_tmpCategory,_tmpSubcategory,_tmpMerchant,_tmpTime,_tmpNote,_tmpConfidence,_tmpRawInput,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<ExpenseEntity>> getRecent(final int limit) {
    final String _sql = "SELECT * FROM expense ORDER BY time DESC LIMIT ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
  ...
  @Override
  public Flow<List<ExpenseEntity>> getAll() {
    final String _sql = "SELECT * FROM expense ORDER BY time DESC";
  ...
  public Flow<Long> getSumByTimeRange(final long startTime, final long endTime) {
    final String _sql = "SELECT SUM(amount) FROM expense WHERE time BETWEEN ? AND ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, startTime);
    _argIndex = 2;
    _statement.bindLong(_argIndex, endTime);
    return CoroutinesRoom.createFlow(__db, false, new String[]{"expense"}, new Callable<Long>() {
      @Override
      public Long call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
        try {
  ...
  public Flow<List<CategoryAmount>> getCategoryStats(final long startTime, final long endTime) {
    final String _sql = "SELECT category, SUM(amount) as totalAmount FROM expense WHERE time BETWEEN ? AND ? GROUP BY category ORDER BY totalAmount DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, startTime);
    _argIndex = 2;
    _statement.bindLong(_argIndex, endTime);
    return CoroutinesRoom.createFlow(__db, false, new String[]{"expense"}, new Callable<List<CategoryAmount>>() {
      @Override
